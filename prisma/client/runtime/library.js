...
var Vo = {
  enabled:
    !Mo && $o == null && qo !== "dumb" && ((ni != null && ni !== "0") || jo),
};
function F(e, r) {
  ...
  Ee = (e, r, t) => {
    ...
    if (ai(e)) {
      ...
      return Reflect.ownKeys(e).every((n) => {
        let i = e[n];
        return (
          (n in r || (Qt((o = i)) && o[De]().matcherType === "optional")) &&
          Ee(i, r[n], t)
        );
        var o;
      });
...
var ci = class e {
  ...
  when(r, t) {
    ...
    return new e(
      this.input,
      n ? { matched: !0, value: t(this.input, this.input) } : ui,
    );
  }
  otherwise(r) {
  ...
  toString() {
    let { config: r } = this,
      t = r.provider.fromEnvVar
        ...
        : r.provider.value,
      n = JSON.parse(
        JSON.stringify({ provider: t, binaryTargets: Jc(r.binaryTargets) }),
      );
...
m.precision = m.sd = function (e) {
  ...
  return (
    t.d ? ((r = Qs(t.d)), e && t.e + 1 > r && (r = t.e + 1)) : (r = NaN),
    r
  );
};
m.round = function () {
...
function Je(e, r) {
  ...
  if (
    ...
    ((o = h.e),
      n > 1 ? ((h = new v("0." + t)), o++) : (h = new v(n + "." + t.slice(1))));
  } else
    return (
  ...
  for (
    p = h,
      l = s = h = L(h.minus(1), h.plus(1), c, 1),
      d = y(h.times(h), c, 1),
      i = 3;
    ;
  ) {
...
var md = (e) => e,
  ...
  P = {
    ...
    disableWorkerMessageHandler:
      bn.Prism && bn.Prism.disableWorkerMessageHandler,
    util: {
      encode: function (e) {
        if (e instanceof ge) {
          let r = e;
      ...
      objId: function (e) {
        return (
          e.__id || Object.defineProperty(e, "__id", { value: ++fd }),
          e.__id
        );
      },
...
function qr(e = {}) {
  ...
  return Object.entries(r).reduce(
    (n, [i, o]) => (
      ja[i] !== void 0 ? (n.select[i] = { select: o }) : (n[i] = o),
      n
    ),
    { select: {} },
  );
...
function gf(e) {
  ...
  return (
    process.platform !== "win32" &&
      (i =
        Po.default.constants.dlopen.RTLD_LAZY |
        Po.default.constants.dlopen.RTLD_DEEPBIND),
