...
C.precision = C.sd = function (e) {
  ...
  return (
    r.d ? ((t = go(r.d)), e && r.e + 1 > t && (t = r.e + 1)) : (t = NaN),
    t
  );
};
C.round = function () {
  ...
  for (let n of e) {
    ...
    o
      ? t.set(i, {
          ...
          argument: {
            ...n.argument,
            typeNames: Du(o.argument.typeNames, n.argument.typeNames),
          },
        })
      : t.set(i, n);
  }
...
function dt(e = {}) {
  ...
  return Object.entries(t).reduce(
    (n, [i, o]) => (
      ss[i] !== void 0 ? (n.select[i] = { select: o }) : (n[i] = o),
      n
    ),
    { select: {} },
  );
...
var Wt = class extends V {
  ...
  logs;
  constructor(t, r) {
    (super("Engine not started: healthcheck timeout", L(t, !0)),
      (this.logs = r));
  }
};
...
async function ep(e, t) {
  ...
  if (o !== void 0 || n === "0.0.0" || n === "in-memory") {
    ...
    try {
      ...
      throw (
        console.error("JSON.parse error: body fetched from unpkg.com: ", v),
        A
      );
    }
    return S.version;
