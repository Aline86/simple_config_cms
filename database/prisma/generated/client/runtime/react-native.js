...
var Pi = Ae((rt) => {
  ...
  var li = (e, t) => () => (
    ...
    Ta = li((e) => {
      ...
      function R(C) {
        for (
          var A, I = C.length, F = I % 3, L = [], k = 16383, N = 0, z = I - F;
          N < z;
          N += k
        )
...
S.inverseTangent = S.atan = function () {
  ...
  for (
    _ = !1, t = Math.ceil(a / M), n = 1, l = u.times(u), s = new g(u), i = u;
    e !== -1;
  )
    if (
      ((i = i.times(l)),
...
S.precision = S.sd = function (e) {
  ...
  return (
    r.d ? ((t = lo(r.d)), e && r.e + 1 > t && (t = r.e + 1)) : (t = NaN),
    t
  );
};
S.round = function () {
  ...
  e: if (t != null) {
    ...
    if (
      ...
      return (
        (h.length = 0),
        u
          ? ((t -= e.e + 1), (h[0] = J(10, (M - (t % M)) % M)), (e.e = -t || 0))
          : (h[0] = e.e = 0),
        e
      );
    if (
...
var Uu = (e) => e,
  ...
  D = {
    ...
    util: {
      ...
      objId: function (e) {
        return (
          e.__id || Object.defineProperty(e, "__id", { value: ++Vu }),
          e.__id
        );
      },
